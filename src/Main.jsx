...
export default function Main() {
    return (
        <div className="links">
            ...
            <a target="_blank" href="http://books.zuri.team" id="books">Zuri Team</a>
            <a target="_blank" href="https://books.zuri.team/" id="book__python">Zuri Books</a>
            <a target="_blank" href="https://books.zuri.team/python-for-beginners?ref_id=<Mcjethro>" id="book__python">Python Books</a>
